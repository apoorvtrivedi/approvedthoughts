---
title: "Links: Semiquincentennial Day"
date: 2026-07-04
type: links
description: 
tags: ["links"]
...
1.
   ...
   date: Fri Jun 26 16:25:51 +0000 2026
   image: https://pbs.twimg.com/media/HLwM2rwXYAA6RDD.png
   body: |
     A truly striking chart in @jburnmurdoch's latest (link next):
   :::

   One of the most important charts of the year. Growth, for the lack of a better word, is good.

2. [Chloe vs. History](https://www.youtube.com/@ChloeVSHistory) via [MR](https://marginalrevolution.com/marginalrevolution/2026/06/chloe-vs-history.html)
   
   ![embed](https://www.youtube.com/watch?v=aaua5ghidk0)
   
   New business models enabled by AI starting to come into focus. 

3.
   ::: tweet
   url: https://twitter.com/karpathy/status/1756380066580455557
   author: Andrej Karpathy
   handle: karpathy
   date: Sat Feb 10 18:10:14 +0000 2024
   body: |
...
4. [Breakthroughs](https://www.nytimes.com/2026/07/01/science/spud-cell-what-to-know.html?unlocked_article_code=1.ulA.dI6T.zs_dUYp_8_3M&smid=url-share) in [biology](https://www.conception.bio/science-and-updates/the-first-early-human-eggs-from-stem-cells)
...
5.
   ::: tweet
   url: https://twitter.com/weaverobotics/status/2072362538671706314
   author: Weave Robotics
   handle: weaverobotics
   date: Wed Jul 01 16:51:46 +0000 2026
   image: https://pbs.twimg.com/amplify_video_thumb/2072362479729172480/img/5aF3QXZvYFJxNP4g.jpg
   body: |
...
7. [Learning to Replicate Expert Judgment in Financial Tasks](https://thinkingmachines.ai/news/learning-to-replicate-expert-judgment-in-financial-tasks/)
...
8.
   ::: tweet
   url: https://twitter.com/arindam___paul/status/2072623462359973932
   author: Arindam Paul
   handle: arindam___paul
   date: Thu Jul 02 10:08:35 +0000 2026
   body: |

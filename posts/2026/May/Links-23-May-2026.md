---
title: "Links: Weeks of 23 May 2026"
date: 2026-05-23
type: links
description: 
tags: ["links"]
...
1.
   ...
   body: |
     this is well aligned model behavior and you see the same from psychotherapists who want to help their patients stop ruminating. the best possible digital assistant will not be one that never causes you discomfort
   :::
   
   ::: tweet
   url: https://twitter.com/hamostaf04/status/2055565214331138076
   author: hamza mostafa
   handle: hamostaf04
   date: Sat May 16 08:25:12 +0000 2026
   image: https://pbs.twimg.com/media/HIbVp1naUAA7wad.png
   body: |
...
2.
   ::: tweet
   url: https://twitter.com/TheStalwart/status/2056892182741536973
   author: Joe Weisenthal
   handle: TheStalwart
   date: Wed May 20 00:18:06 +0000 2026
   image: https://pbs.twimg.com/media/HIuLyNyWsAAwPQN.png
   body: |
     I had two bots ask Opus 4.7 for analysis of what a major Chilean supply shock would mean for copper
     
     But before asking, I had warmup questions that exhibited different levels of sophistication. Despite both bots asking for max thoroughness, those warmups affected the final output
   :::

3. As much as I love WFH, especially with the extra long NJ commute, this strikes true. 
   ::: tweet
   url: https://twitter.com/pj_lambert/status/2057477629528150369
   author: Peter John Lambert
   handle: pj_lambert
   date: Thu May 21 15:04:27 +0000 2026
   image: https://pbs.twimg.com/media/HI2g_UKWoAAAINl.jpg
   body: |
...
4.
   ::: tweet
   url: https://twitter.com/cullenroche/status/2057501960992096727
   author: Cullen Roche
   handle: cullenroche
   date: Thu May 21 16:41:08 +0000 2026
   body: |
     Lost one of my very first clients recently. Amid the grief, it re-emphasized a hard financial truth:
     
     Dying is expensive and causes an immediate, massive liquidity crunch for a family long before the estate settles.
     
     If you want to protect your family from administrative gridlock, check these 3 things today:
     
     1) Update trusts, wills and estate and ensure trusts are funded: A trust is useless if it's empty. Ensure taxable accounts and deeds are actually retitled to the trust.
     
     2) Doublecheck beneficiaries and make taxable accounts and bank accounts TOD at a minimum before the Death Certificate Bottleneck kicks in: Custodians legally cannot release beneficiary accounts without a death certificate. In many jurisdictions, these take weeks or months to process.
     
     3) Immediate Liquidity: Ensure your spouse or heirs have immediate access to operational cash in a joint or accessible account to cover sudden costs (travel, arrangements, immediate bills) while the larger estate is verified.
     
     4) Hug your loved ones!
   :::

5. Vibes in SF (see link #2 last week) vs. vibes in NJ ;-)
   ::: tweet
   url: https://twitter.com/staysaasy/status/2056028491292823942
   author: staysaasy
   handle: staysaasy
   date: Sun May 17 15:06:06 +0000 2026
   body: |
